...
#check whether 5 tabs and enter invoke the windows window
						...
						for line in video_line[turn:]:
							...
							if n<num_of_video:
								try:
									...
									pyautogui.typewrite('"' + video_arr + '.mkv"' + " ")
									time.sleep(1)
		...
		for i in range(0,30):
			if i<29:
				try:
					print("uploading........")
					ele= driver.find_element_by_xpath("//*[@id='anchor-1']/div[1]/div[4]/button[2]")
						# 鼠标移到悬停元素上
					ActionChains(driver).move_to_element(ele).perform()
					ActionChains(driver).reset_actions()
		...
		for i in range(0,20):
			if i<19:
				try:
					...
					driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[4]/div[3]/div[2]/div[3]/div/div[2]/div[1]/div[2]/div[2]/div[1]/div/div/div[2]/div[1]/img").click()
