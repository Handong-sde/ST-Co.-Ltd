		...
		for i in range(0,20):
			if i<19:
				try:
					...
					ActionChains(driver).reset_actions()
					#dian ji list
					driver.find_element_by_xpath("//*[@id='managePage']/div[2]/div/div/div[1]/div/ul/li[2]/a").click()#点击发视频
					print("success hover")
					time.sleep(range2)
					break
				except Exception as e:
...
#check whether 5 tabs and enter invoke the windows window
			...
			if l<4:
				...
				for i in range(0,20):
					if i<19:
						try:
							# num = str(len(3))
							pyautogui.typewrite('F:\\work\\YIDIAN_shipin\\video')
							time.sleep(range1)
							pyautogui.press('enter')
							time.sleep(range2)
							break
						...
						for line in video_line[turn:]:
							...
							if n<num_of_video:
								try:
									...
									pyautogui.typewrite('"' + video_arr + '.mp4"' + " ")
									time.sleep(1)
				...
				try:
					...
					driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[1]/div[2]/input").click()
					print("success enter the video page")
					break
				except Exception as e:
					driver.refresh()
					l+=1
		...
		# 	if i<19:
		# 		try:
		# 			ele= driver.find_element_by_xpath("//*[@id='anchor-1']/div[1]/div[1]/div[2]/button[1]")
		# 				# 鼠标移到悬停元素上
		# 			ActionChains(driver).move_to_element(ele).perform()
		# 			ActionChains(driver).reset_actions()
		# 			print("success check")
		...
		for i in range(0,30):
			if i<29:
				try:
					...
					# ActionChains(driver).move_to_element(ele).perform()
					# ActionChains(driver).reset_actions()
					val = driver.find_element_by_xpath("/html/body/div[1]/div/div[3]/div[2]/div/div/div/div[2]/div/div[2]/div[2]/div/div[1]/div[1]/span")
					innerT = val.get_attribute('innerHTML')
					print(innerT)
					a = '50'
					if (a) in innerT:
						print("success check re-uplaod")
						break	
					time.sleep(range2)	
				except Exception as e:
					time.sleep(range2)
		...
		# for i in range(0,20):
			# if i<19:
				# try:
					# #分类
					# driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[3]/div[2]/div[1]/div/div/input").click()
					# print("success type1")
					# time.sleep(range1)
					...
					# #选择
					# ele2 = driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[3]/div[2]/div[1]/div/div[2]/div/ul/li[29]")
					...
					# #zi分类
					# ##ele3 = driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[3]/div[2]/div[1]/div/div[2]/div/div/ul/li[4]")
		...
		for i in range(0,20):
			if i<9:
				try:
					...
					# driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[4]/div[3]/div[2]/div[3]/div/div[1]/div/div[2]/div/div[2]/input").click()
					# print("success click local upload cover")
					# time.sleep(range1)
...
#press enter for uploading cover
		...
		for i in range(0,20):
			if i<19:
				try:
					print("check upload cover")
					driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[4]/div[3]/div[2]/div[3]/div/div[2]/div[1]/div[2]").click()
					print("success click img")
					time.sleep(range1)
					break
				except Exception as e:
					time.sleep(range2)
		...
		if quit_error == False:
			...
			# for i in range(0,20):
				# if i<20:
					# try:
						# print("check cover upload again")
						# driver.find_element_by_xpath("//*[@id='anchor-1']/div[2]/div[1]/div[2]/input").click()
						# time.sleep(range2)
